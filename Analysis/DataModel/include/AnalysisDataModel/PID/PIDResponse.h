...
constexpr float bin_width = (binned_max - binned_min) / nbins;
// NSigma with reduced size
DECLARE_SOA_COLUMN(BayesStoreEl, bayesStoreEl, binned_prob_t); //! Stored Bayesian probability for electron
DECLARE_SOA_COLUMN(BayesStoreMu, bayesStoreMu, binned_prob_t); //! Stored Bayesian probability for muon
DECLARE_SOA_COLUMN(BayesStorePi, bayesStorePi, binned_prob_t); //! Stored Bayesian probability for pion
DECLARE_SOA_COLUMN(BayesStoreKa, bayesStoreKa, binned_prob_t); //! Stored Bayesian probability for kaon
DECLARE_SOA_COLUMN(BayesStorePr, bayesStorePr, binned_prob_t); //! Stored Bayesian probability for proton
DECLARE_SOA_COLUMN(BayesStoreDe, bayesStoreDe, binned_prob_t); //! Stored Bayesian probability for deuteron
DECLARE_SOA_COLUMN(BayesStoreTr, bayesStoreTr, binned_prob_t); //! Stored Bayesian probability for triton
DECLARE_SOA_COLUMN(BayesStoreHe, bayesStoreHe, binned_prob_t); //! Stored Bayesian probability for helium3
DECLARE_SOA_COLUMN(BayesStoreAl, bayesStoreAl, binned_prob_t); //! Stored Bayesian probability for alpha
// // NSigma with reduced size in [binned_min, binned_max] bin size bin_width
