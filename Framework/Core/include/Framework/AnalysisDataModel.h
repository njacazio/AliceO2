...
// DECLARE_SOA_EXPRESSION_COLUMN(Phi, phi, float, //! Phi
...
DECLARE_SOA_EXPRESSION_COLUMN(P, p, float, //! Total momentum in GeV/c
                              nsqrt(aod::mcparticle::px* aod::mcparticle::px +
                                    aod::mcparticle::py * aod::mcparticle::py +
                                    aod::mcparticle::pz * aod::mcparticle::pz));
DECLARE_SOA_EXPRESSION_COLUMN(Y, y, float, //! Particle rapidity
                              0.5f * nlog((aod::mcparticle::e + aod::mcparticle::pz) / (aod::mcparticle::e - aod::mcparticle::pz)));
} // namespace mcparticle
